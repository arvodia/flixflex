        ...
        <div class="flex flex-nowrap lg:ml-40 md:ml-20 ml-10 ">
            <div v-for="movie in movies.results" class="inline-block px-3">
                <div class="h-64 max-w-xs overflow-hidden rounded-lg shadow-md bg-white hover:shadow-xl transition-shadow duration-300 ease-in-out">
                     <router-link :to="{name:'Serie',params:{id:movie.id}}" href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
...
<script>
    ...
    import useMovies from '../services/topTvService.js';
    export default{
        setup() {
